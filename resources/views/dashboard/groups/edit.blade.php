                        ...
                        <form action="{{ route('dashboard.groups.update', $group->id) }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    value="{{ (old('name')) ? old('name') : $group->name }}" required>
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="3">{{ (old('description')) ? old('description') : $group->description }}</textarea>
                                    @error('description')
                                        <x-error-input :message="$message"/>
                                    @enderror
                                </div>
