                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="email" name="email" placeholder="E-mail do usuário" disabled wire:model="email">
                        </div>
                        @error('email')
                            <x-error-input :message="$message"/>
                        @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="is_admin" checked wire:model="is_admin">
                                <label class="form-check-label" for="is_admin">Sim</label>
                              </div>
                              @error('is_admin')
